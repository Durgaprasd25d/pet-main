...
export const ReportLostPetScreen = ({ navigation }: any) => {
  ...
  const validateForm = () => {
    ...
    if (!formData.location.trim()) newErrors.location = 'Last seen location is required';
  ...
  const handleReport = async () => {
    ...
    if (!selectedImage) {
      Alert.alert('Photo Required', 'Please upload a photo of the pet to help with identification.');
      return;
    }
    ...
    try {
      ...
      Alert.alert(
        'Report Submitted', 
        'Your report has been broadcast to the community. We hope you find your pet soon!',
  ...
  const renderTypeSelector = (label: string, icon: string) => (
    <TouchableOpacity 
      ...
      activeOpacity={0.7}
    >
      <View style={[styles.typeIconContainer, formData.type === label && { backgroundColor: COLORS.error + '15' }]}>
        <MaterialDesignIcons 
          name={icon as any} 
          size={24} 
          color={formData.type === label ? COLORS.error : COLORS.textLight} 
        />
      </View>
      <Text style={[styles.typeText, formData.type === label && { color: COLORS.error, fontWeight: '800' }]}>{label}</Text>
    </TouchableOpacity>
  );
      ...
      >
        ...
        >
          ...
          <View style={styles.sectionHeader}>
            <Text style={styles.sectionTitle}>Pet Media</Text>
            ...
            {selectedImage ? (
              ...
              <TouchableOpacity style={styles.uploadBox} onPress={selectImage} activeOpacity={0.6}>
                <View style={styles.uploadCircle}>
                  <MaterialDesignIcons name="camera-plus" size={32} color={COLORS.error} />
                </View>
                <Text style={styles.uploadTitle}>Photo of your pet</Text>
                <Text style={styles.uploadSub}>Clear photo helps in reunion</Text>
              </TouchableOpacity>
            )}
          </View>
          ...
          <Input 
            ...
            placeholder="Collar color, unique marks, behavioral traits..." 
          ...
          <Text style={styles.footerNote}>
            Submitting this report will also post it to the community "Talk" feed for maximum reach.
          </Text>
